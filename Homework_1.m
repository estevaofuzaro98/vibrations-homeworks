...
for st=1:3
    ...
    grid on; grid minor;
    legend('$h(t)$','Envelope','','fontsize',15)
    if st==1
        axis([0 1 -1e-2 1e-2])
    elseif st==2
        axis([0 10 -1e-2 1e-2])
...
for st=1:3
    subplot(1,3,st)
    if st==1
        loglog(f,abs(Hjw(st,:)),'m','linewidth', 1.5), hold on
        axis([1e-1 1e2 1e-6 1e-2])
    elseif st==2
        loglog(f,abs(Hjw(st,:)),'k','linewidth', 1.5), hold on
        axis([1e-1 1e2 1e-6 1e-1])
    else
        loglog(f,abs(Hjw(st,:)),'b','linewidth', 1.5), hold on
        axis([1e-1 1e2 1e-6 1e0])
    end
    loglog(f,1/k*ones(1,length(w)),'--r','linewidth', 1.2), hold on % Stiffness
    loglog(f,1./(w.^2*m),'--','linewidth', 1.2), hold on % Mass
    xlabel('$f$ [Hz]')
    ylabel('Receptance [m/N]')
    legend('$\left| X/F \right|$','Stiffness Line','Mass Line','Location','southwest','fontsize',15)
...
for st=1:3
    subplot(1,3,st)
    if st==1
        plot(f,rad2deg(angle(Hjw(st,:))),'m','linewidth', 1.5), hold on
    elseif st==2
        plot(f,rad2deg(angle(Hjw(st,:))),'k','linewidth', 1.5), hold on
    else
        plot(f,rad2deg(angle(Hjw(st,:))),'b','linewidth', 1.5), hold on
    end
...
loglog(f,abs(Hjw(3,:)),'b','linewidth', 1.5), hold on % Zeta = 0.001
loglog(f,1/k*ones(1,length(w)),'--r','linewidth', 1.2), hold on % Stiffness
loglog(f,1./(w.^2*m),'--','linewidth', 1.2), hold on % Mass
xlabel('$f$ [Hz]')
ylabel('Receptance [m/N]')
legend({['$\left| X/F \right|, \, \zeta = ', num2str(z(1)),' $'],['$\left| X/F \right|, \, \zeta = ', num2str(z(2)),' $'],['$\left| X/F \right|, \, \zeta = ', num2str(z(3)),' $'],'Stiffness Line','Mass Line'},'Location','southwest','fontsize',15)
grid on; grid minor;
axis([1 1e2 1e-6 1e-1])
set(gca,'fontsize',18,'XColor','k','YColor','k','ZColor','k','GridColor','k')
subplot(1,2,2)
plot(f,rad2deg(angle(Hjw(1,:))),'m','linewidth', 1.5), hold on % Zeta = 0.1
plot(f,rad2deg(angle(Hjw(2,:))),'k','linewidth', 1.5), hold on % Zeta = 0.01
...
for st=1:3
    subplot(1,3,st)
    if st == 1
        plot(f,real(Hjw(st,:)),'m','linewidth', 1.7)
        axis([0 30 -0.3e-3 +0.3e-3])
    elseif st == 2
        plot(f,real(Hjw(st,:)),'k','linewidth', 1.7)
        axis([0 30 -0.3e-2 +0.3e-2])
    else
        plot(f,real(Hjw(st,:)),'b','linewidth', 1.7)
        axis([0 30 -0.3e-1 +0.3e-1])
    end
    xlabel('$f$ [Hz]')
    ylabel('$Re\{\frac{X}{F}\}$')
    title(['$\zeta = ', num2str(z(st)),' $'],'FontWeight','normal')
    legend('$Re\{\frac{X}{F}\}$','Location','southwest','fontsize',15)
    grid on, grid minor
    set(gca,'fontsize',18,'XColor','k','YColor','k','ZColor','k','GridColor','k')
end
...
for st=1:3
    subplot(1,3,st)
    if st == 1
        plot(f,imag(Hjw(st,:)),'m','linewidth', 1.7)
        axis([0 30 -0.00055 0])
        set(gca,'YTick',[-0.00055:0.00005:0]) %#ok<*NBRAK>
    elseif st == 2
        plot(f,imag(Hjw(st,:)),'k','linewidth', 1.7)
        axis([0 30 -0.0055 0])
        set(gca,'YTick',[-0.0055:0.0005:0])
    else
        plot(f,imag(Hjw(st,:)),'b','linewidth', 1.7)
        axis([0 30 -0.055 0])
    ...
    ylabel('$Im\{\frac{X}{F}\}$')
    title(['$\zeta = ', num2str(z(st)),' $'],'FontWeight','normal')
    legend('$Im\{\frac{X}{F}\}$','Location','southwest','fontsize',15)
    grid on, grid minor
    set(gca,'fontsize',18,'XColor','k','YColor','k','ZColor','k','GridColor','k')
end
...
plot(f,real(Hjw(3,:)),'b','linewidth', 1.7), hold on % Zeta = 0.001
xlabel('$f$ [Hz]')
ylabel('$Re\{\frac{X}{F}\}$')
legend(['$Re\{X/F\}, \, \zeta = ', num2str(z(1)),' $'],['$Re\{X/F\}, \, \zeta = ', num2str(z(2)),' $'],['$Re\{X/F\}, \, \zeta = ', num2str(z(3)),' $'],'Location','southeast','fontsize',16)
grid on, grid minor,
axis([14 18 -0.3e-1 +0.3e-1])
set(gca,'fontsize',18)
subplot(1,2,2)
plot(f,imag(Hjw(1,:)),'m','linewidth', 1.7), hold on
plot(f,imag(Hjw(2,:)),'k','linewidth', 1.7), hold on
plot(f,imag(Hjw(3,:)),'b','linewidth', 1.7), hold on
axis([14 18 -0.051 0])
xlabel('$f$ [Hz]')
ylabel('$Im\{\frac{X}{F}\}$')
legend(['$Im\{X/F\}, \, \zeta = ', num2str(z(1)),' $'],['$Im\{X/F\}, \, \zeta = ', num2str(z(2)),' $'],['$Im\{X/F\}, \, \zeta = ', num2str(z(3)),' $'],'Location','southeast','fontsize',16)
grid on, grid minor
set(gca,'fontsize',18,'XColor','k','YColor','k','ZColor','k','GridColor','k')
...
xlabel('$Re\{\frac{X}{F}\}$')
ylabel('$Im\{\frac{X}{F}\}$')
legend(['$\zeta = ', num2str(z(1)),' $'],['$\zeta = ', num2str(z(2)),' $'],['$\zeta = ', num2str(z(3)),' $'],'Location','southeast','fontsize',15)
set(gca,'fontsize',18,'XColor','k','YColor','k','ZColor','k','GridColor','k')
grid on, grid minor
axis image
...
for st=1:3
    ...
    ylabel('$Re\{\frac{X}{F}\}$')
    zlabel('$Im\{\frac{X}{F}\}$')
    set(gca,'fontsize',18,'YDir','reverse','XColor','k','YColor','k','ZColor','k','GridColor','k')
    title(['$\zeta = ', num2str(z(st)),' $'],'FontWeight','normal')
    grid on, grid minor
end
...
for st=1:3
    ...
    legend('$\left| \dot{X}/F \right|$','Stiffness Line','Mass Line','Location','southeast','fontsize',15)
    title(['$\zeta = ', num2str(z(st)),' $'],'FontWeight','normal'), grid on, grid minor
    set(gca,'fontsize',18,'XColor','k','YColor','k','ZColor','k','GridColor','k')
end
...
for st=1:3
    subplot(1,3,st)
    if st==1
        plot(f,rad2deg(angle(Hm(st,:))),'m','linewidth', 1.5), hold on
    elseif st==2
        plot(f,rad2deg(angle(Hm(st,:))),'k','linewidth', 1.5), hold on
    else
        plot(f,rad2deg(angle(Hm(st,:))),'b','linewidth', 1.5), hold on
    end
...
loglog(f,abs(Hm(3,:)),'b','linewidth', 1.5), hold on % Zeta = 0.001
loglog(f,abs(1i*w)/k.*ones(1,length(w)),'--r','linewidth', 1.2), hold on % Stiffness
loglog(f,abs(1i*w)./(w.^2*m),'--','linewidth', 1.2), hold on % Mass
xlabel('$f$ [Hz]')
ylabel('Mobility [m/N]')
...
set(gca,'fontsize',18,'XColor','k','YColor','k','ZColor','k','GridColor','k')
subplot(1,2,2)
plot(f,rad2deg(angle(Hm(1,:))),'m','linewidth', 1.5), hold on % Zeta = 0.1
plot(f,rad2deg(angle(Hm(2,:))),'k','linewidth', 1.5), hold on % Zeta = 0.01
...
for st=1:3
    subplot(1,3,st)
    if st == 1
        plot(f,real(Hm(st,:)),'m','linewidth', 1.7)
        axis([0 40 0 0.055])
        set(gca,'XTick',[0 10 20 30 40],'YTick',[0:0.005:0.055])
    elseif st == 2
        plot(f,real(Hm(st,:)),'k','linewidth', 1.7)
        axis([0 40 0 0.55])
        set(gca,'XTick',[0 10 20 30 40],'YTick',[0:0.05:0.55])
    else
        plot(f,real(Hm(st,:)),'b','linewidth', 1.7)
        axis([0 40 0 5.5])
    ...
    title(['$\zeta = ', num2str(z(st)),' $'],'FontWeight','normal')
    legend('$Re\{\frac{\dot{X}}{F}\}$','Location','southwest','fontsize',15)
    grid on, grid minor
    set(gca,'fontsize',18,'XColor','k','YColor','k','ZColor','k','GridColor','k')
end
...
for st=1:3
    subplot(1,3,st)
    if st == 1
        plot(f,imag(Hm(st,:)),'m','linewidth', 1.7)
        axis([0 40 -0.03 0.03])
        set(gca,'YTick',[-0.03:0.005:0.03])
    elseif st == 2
        plot(f,imag(Hm(st,:)),'k','linewidth', 1.7)
        axis([0 40 -0.3 0.3])
        set(gca,'YTick',[-0.3:0.05:0.3])
    else
        plot(f,imag(Hm(st,:)),'b','linewidth', 1.7)
        axis([0 40 -3 3])
    ...
    title(['$\zeta = ', num2str(z(st)),' $'],'FontWeight','normal')
    legend('$Im\{\frac{\dot{X}}{F}\}$','Location','northeast','fontsize',15)
    grid on, grid minor
    set(gca,'fontsize',18,'XColor','k','YColor','k','ZColor','k','GridColor','k')
end
...
plot(f,real(Hm(3,:)),'b','linewidth', 1.7), hold on % Zeta = 0.001
xlabel('$f$ [Hz]')
ylabel('$Re\{\frac{\dot{X}}{F}\}$')
legend(['$Re\{\dot{X}/F\}, \, \zeta = ', num2str(z(1)),' $'],['$Re\{\dot{X}/F\}, \, \zeta = ', num2str(z(2)),' $'],['$Re\{\dot{X}/F\}, \, \zeta = ', num2str(z(3)),' $'],'Location','northeast','fontsize',16)
grid on, grid minor,
set(gca,'YTick',[0:0.5:5.5],'fontsize',18,'XColor','k','YColor','k','ZColor','k','GridColor','k')
axis([12 20 0 5.5])
subplot(1,2,2)
plot(f,imag(Hm(1,:)),'m','linewidth', 1.7), hold on
plot(f,imag(Hm(2,:)),'k','linewidth', 1.7), hold on
plot(f,imag(Hm(3,:)),'b','linewidth', 1.7), hold on
axis([12 20 -3 3])
set(gca,'YTick',[-3:0.5:3],'fontsize',18,'XColor','k','YColor','k','ZColor','k','GridColor','k')
xlabel('$f$ [Hz]')
ylabel('$Im\{\frac{\dot{X}}{F}\}$')
legend(['$Im\{\dot{X}/F\}, \, \zeta = ', num2str(z(1)),' $'],['$Im\{\dot{X}/F\}, \, \zeta = ', num2str(z(2)),' $'],['$Im\{\dot{X}/F\}, \, \zeta = ', num2str(z(3)),' $'],'Location','northeast','fontsize',16)
grid on, grid minor
...
for st=1:3
    ...
    legend('$\left| \ddot{X}/F \right|$','Stiffness Line','Mass Line','Location','southeast','fontsize',15)
    title(['$\zeta = ', num2str(z(st)),' $'],'FontWeight','normal'), grid on, grid minor
    set(gca,'fontsize',18,'XColor','k','YColor','k','ZColor','k','GridColor','k')
end
...
for st=1:3
    subplot(1,3,st)
    if st==1
        plot(f,rad2deg(angle(Ha(st,:))),'m','linewidth', 1.5), hold on
    elseif st==2
        plot(f,rad2deg(angle(Ha(st,:))),'k','linewidth', 1.5), hold on
    else
        plot(f,rad2deg(angle(Ha(st,:))),'b','linewidth', 1.5), hold on
    end
    plot(f,rad2deg(pi/2)*ones(1,length(w)),'--r','linewidth', 1.2), hold on
    xlabel('$f$ [Hz]')
    ylabel('$\phi$ [$^{\circ}$]')
...
loglog(f,abs(Ha(3,:)),'b','linewidth', 1.5), hold on % Zeta = 0.001
loglog(f,abs((1i*w).^2)/k.*ones(1,length(w)),'--r','linewidth', 1.2), hold on % Stiffness
loglog(f,abs((1i*w).^2)./(w.^2*m),'--','linewidth', 1.2), hold on % Mass
xlabel('$f$ [Hz]')
ylabel('Mobility [m/N]')
...
set(gca,'fontsize',18,'XColor','k','YColor','k','ZColor','k','GridColor','k')
subplot(1,2,2)
plot(f,rad2deg(angle(Ha(1,:))),'m','linewidth', 1.5), hold on % Zeta = 0.1
plot(f,rad2deg(angle(Ha(2,:))),'k','linewidth', 1.5), hold on % Zeta = 0.01
...
for st=1:3
    subplot(1,3,st)
    if st == 1
        plot(f,real(Ha(st,:)),'m','linewidth', 1.7)
        axis([0 40 -3 3])
        set(gca,'XTick',[0 10 20 30 40],'YTick',[-3:0.5:3])
    elseif st == 2
        plot(f,real(Ha(st,:)),'k','linewidth', 1.7)
        axis([0 40 -30 30])
        set(gca,'XTick',[0 10 20 30 40],'YTick',[-30:5:30])
    else
        plot(f,real(Ha(st,:)),'b','linewidth', 1.7)
        axis([0 40 -300 300])
    ...
    title(['$\zeta = ', num2str(z(st)),' $'],'FontWeight','normal')
    legend('$Re\{\frac{\ddot{X}}{F}\}$','Location','southeast','fontsize',15)
    grid on, grid minor
    set(gca,'fontsize',18,'XColor','k','YColor','k','ZColor','k','GridColor','k')
end
...
for st=1:3
    subplot(1,3,st)
    if st == 1
        plot(f,imag(Ha(st,:)),'m','linewidth', 1.7)
        axis([0 40 -0.2 5.2])
        set(gca,'YTick',[0:0.5:5])
    elseif st == 2
        plot(f,imag(Ha(st,:)),'k','linewidth', 1.7)
        axis([0 40 -2 52])
        set(gca,'YTick',[0:5:50])
    else
        plot(f,imag(Ha(st,:)),'b','linewidth', 1.7)
        axis([0 40 -20 520])
    ...
    title(['$\zeta = ', num2str(z(st)),' $'],'FontWeight','normal')
    legend('$Im\{\frac{\ddot{X}}{F}\}$','Location','northeast','fontsize',15)
    grid on, grid minor
    set(gca,'fontsize',18,'XColor','k','YColor','k','ZColor','k','GridColor','k')
end
...
plot(f,real(Ha(3,:)),'b','linewidth', 1.7), hold on % Zeta = 0.001
xlabel('$f$ [Hz]')
ylabel('$Re\{\frac{\ddot{X}}{F}\}$')
legend(['$Re\{\ddot{X}/F\}, \, \zeta = ', num2str(z(1)),' $'],['$Re\{\ddot{X}/F\}, \, \zeta = ', num2str(z(2)),' $'],['$Re\{\ddot{X}/F\}, \, \zeta = ', num2str(z(3)),' $'],'Location','northwest','fontsize',16)
grid on, grid minor,
set(gca,'YTick',[-300:50:300],'fontsize',18,'XColor','k','YColor','k','ZColor','k','GridColor','k')
axis([0 30 -300 300])
subplot(1,2,2)
plot(f,imag(Ha(1,:)),'m','linewidth', 1.7), hold on
plot(f,imag(Ha(2,:)),'k','linewidth', 1.7), hold on
plot(f,imag(Ha(3,:)),'b','linewidth', 1.7), hold on
axis([0 30 -20 520])
set(gca,'YTick',[0:50:500],'fontsize',18,'XColor','k','YColor','k','ZColor','k','GridColor','k')
xlabel('$f$ [Hz]')
ylabel('$Im\{\frac{\ddot{X}}{F}\}$')
legend(['$Im\{\ddot{X}/F\}, \, \zeta = ', num2str(z(1)),' $'],['$Im\{\ddot{X}/F\}, \, \zeta = ', num2str(z(2)),' $'],['$Im\{\ddot{X}/F\}, \, \zeta = ', num2str(z(3)),' $'],'Location','northwest','fontsize',16)
grid on, grid minor
